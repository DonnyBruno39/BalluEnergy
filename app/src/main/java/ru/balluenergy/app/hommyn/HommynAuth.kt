...
object HommynAuth {
    ...
    fun init(phone: String): Challenge {
        ...
        // Reproduce the important shape of Hommyn 1.18.3's initAuth request.
        // The original app passes a Google Sign-In client object as deviceInfo.
        // Its serialized instance contains the package identifier rather than a
        // random UUID generated by our custom client.
