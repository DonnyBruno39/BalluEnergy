...
object HommynAuth {
    ...
    /**
     * Keep the initAuth payload shape that was proven to reach the Hommyn SMS
     * service. The previous v0.3.5 zbd replacement was structurally different
     * and caused SMS_SEND_FAILED before a session was created.
     */
    fun init(context: Context, phone: String): Challenge {
        ...
        val body = linkedMapOf<String, Any>(
            ...
            "deviceInfo" to mapOf("a" to "com.hommyn.app"),
            "locales" to listOf(Locale.getDefault().toString()),
